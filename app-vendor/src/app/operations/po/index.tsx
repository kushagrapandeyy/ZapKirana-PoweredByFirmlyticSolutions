...
const styles = StyleSheet.create({
  ...
  poCard: { backgroundColor: '#fff', borderRadius: Radius.xl, marginBottom: 16, ...Shadows.sm, borderWidth: 1, borderColor: '#F1F5F9' },
  poHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', padding: 16 },
  ...
  amountLabel: { fontSize: 11, fontFamily: 'Inter_600SemiBold', color: Colors.textMuted, textTransform: 'uppercase', marginBottom: 2 },
  amountValue: { fontSize: 16, fontFamily: 'Inter_700Bold', color: Colors.primaryDark },
  
  poFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: '#F8FAFC', borderBottomLeftRadius: Radius.xl, borderBottomRightRadius: Radius.xl, borderTopWidth: 1, borderTopColor: '#F1F5F9' },
