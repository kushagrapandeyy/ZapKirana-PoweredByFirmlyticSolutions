...
exports.AdminGovernanceModule = void 0;
...
exports.AdminGovernanceModule = AdminGovernanceModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [admin_governance_service_1.AdminGovernanceService, prisma_service_1.PrismaService],
        exports: [admin_governance_service_1.AdminGovernanceService],
    })
